forked from https://github.com/jsfaint/im-select

# im-select

使用[aardio](https://aardio.com/)开发的[im-select](https://github.com/daipeihust/im-select)克隆版，仅支持windows系统。

原始的`im-select`在win10下使用需要添加多语言，即需要同时有英文与中文，通过`win+space`切换切换语言。 个人还是更习惯从win95时代就在使用的`ctrl+space`，win10也支持设置快捷键使用`ctrl+space`来切换输入法中英文状态，所以就有了这个克隆版。
